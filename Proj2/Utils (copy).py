...
################################################################################
################################################################################
def train_model_no_batch(model, train_input, train_target, loss_criterion, optimizer, eta, epochs, verbose):
    losses = []
...
################################################################################
def test_model_wip(model, test_input, test_target, loss_criterion, verbose):
    n_errors = 0
    n_correct = 0
    cx, cy, ix, iy = [], [], [], []
    l = []
